...
export function registerCustomFieldTools(
  ...
  server.registerTool("list_custom_fields", { description: "List all custom fields defined in the ManyChat account", inputSchema: z.object({}) }, async () => {
  ...
  server.registerTool("create_custom_field", { description: "Create a new custom field in the ManyChat account", inputSchema: z.object({
  ...
  server.registerTool("set_custom_field", { description: "Set a custom field value for a subscriber by field ID", inputSchema: z.object({
  ...
  server.registerTool("set_custom_field_by_name", { description: "Set a custom field value for a subscriber by field name", inputSchema: z.object({
                subscriber_id: z.number().describe("The subscriber's numeric ID"),
  ...
  server.registerTool("set_custom_fields_bulk", { description: "Set multiple custom field values for a subscriber at once (max 20 fields)", inputSchema: z.object({
                subscriber_id: z.number().describe("The subscriber's numeric ID"),
                fields: z
                  .array(
                    z.object({
